var belong = angular.module('beLong', ['ui.router','ui.bootstrap']);
belong.config(["$httpProvider", function ($httpProvider) {
...
belong.provider('loadingBar', function () {
...
belong.config([
    ...
    function ($stateProvider, $urlRouterProvider) {
        ...
        $urlRouterProvider.otherwise('/mobiles');
        $stateProvider.state('mobiles', {
            url: '/mobiles',
            views: {
                'index': {
                    templateUrl: 'partials/mobile.html',
                    controller: 'MobileController as mCtrl'
                }
            }
        })
    }
